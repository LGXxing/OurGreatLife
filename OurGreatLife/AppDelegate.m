...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _tabBarViewCtrl = [[OurTabBarViewController alloc] init];
   [DWScrollPictures dw_AppdelegateNewFeaturesWindow:self.window
                                        newFeaturesVC:[[OTBootstrapViewController alloc] init]                                               mainVC:_tabBarViewCtrl];
    //self.window.rootViewController = _tabBarViewCtrl;
